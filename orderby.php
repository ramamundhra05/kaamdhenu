	...
	<header class="top-navbar">
        ...
        <div class="container-fluid">
            <div class="form-group">
                ...
                <h2 style="background-color: orange; opacity: 0.6;"><center><strong>PLACE ORDER</strong></center></h2><hr>
				...
				<div class="card-header">
					...
					<div class="row">
								...
								<div class="card-header">
									<div class="form-group">
										...
										<h7>If you want to place order fill the given form.</h7>
											<form action="orderby1.php" method="post">
											<h3 class="display-4 text-text-muted "><mark><?php print_r($msg)?></mark></h3>

												
											 <input type="hidden" name="sn" value=<?php echo "$sn"?>/><br> 
												...
												<button  class="btn btn-warning btn-outline-danger">Place Order</button>
						...
						<div class="col-sm-6">
							...
							<img src="banner/11.jpg" width="510" height="544"/>
						</div>
				</div>
			</div>
</body>
